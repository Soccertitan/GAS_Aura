...
void USpellMenuWidgetController::BroadcastInitialValues()
{
	...
	OnSpellPointsChanged.Broadcast(CurrentSpellPoints);
}
...
void USpellMenuWidgetController::SpellRowGlobePressed(const FGameplayTag& SlotTag, const FGameplayTag& AbilityType)
{
	...
	// Don't equip an offensive spell in a passive slot or vice versa.
	const FGameplayTag& SelecteAbilityType = AbilityInfo->FindAbilityInfoForTag(SelectedAbility.Ability).AbilityType;
	if (!SelecteAbilityType.MatchesTagExact(AbilityType)) return;
